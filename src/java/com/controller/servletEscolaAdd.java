 ...
 * @author jeferson
 */
@WebServlet(name = "servletEscolaAdd", urlPatterns = {"/servletEscolaAdd"})
public class servletEscolaAdd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
            ...
            escola.setEndereço("endereco");
           try{
          if(resposta =  escola.cadastrar(escola)){
